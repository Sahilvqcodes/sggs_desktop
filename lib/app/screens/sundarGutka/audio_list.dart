...
class _AudioState extends State<Audio> {
  ...
  List<AudioM> _audioList = [
    AudioM(
      audioName: "French Language",
      audioLink:
          "https://www.dropbox.com/s/wwwo0h75v2pj4e2/Japji-French.mp3?dl=0",
    ),
    AudioM(
      audioName: "German Language",
      audioLink:
          "https://www.dropbox.com/s/d5aixfx7d8re1kn/Japji-German.mp3?dl=0",
    ),
    AudioM(
      audioName: "Italian Language",
      audioLink:
          "https://www.dropbox.com/s/4gk4iaaanj1ulvm/Japji-Italian.mp3?dl=0",
    ),
    AudioM(
      audioName: "Russain Language",
      audioLink:
          "https://www.dropbox.com/s/ovft95alo7ri8r0/JapJi-Russian.mp3?dl=0",
    ),
    AudioM(
      audioName: "Arabic   Language",
      audioLink:
          "https://www.dropbox.com/s/l6xxpr38dc530uq/Japji-Arabic.mp3?dl=0",
    ),
    AudioM(
      audioName: "Polish Language",
      audioLink:
          "https://www.dropbox.com/s/hrkyzs1vacwhkhe/Japji-Polish.mp3?dl=0",
    ),
    AudioM(
      audioName: "Swahili Language",
      audioLink:
          "https://www.dropbox.com/s/w0125g1b28q17mb/Japji-Swahili.mp3?dl=0",
    ),
    AudioM(
      audioName: "Turkish  Language",
      audioLink:
          "https://www.dropbox.com/s/0cmk1zgf22szr2j/Japji-Turkish.mp3?dl=0",
    ),
    AudioM(
      audioName: "Mandarin Language",
      audioLink:
          "https://www.dropbox.com/s/og65vmlv6wiw1hl/Japji-mandarin.mp3?dl=0",
    ),
    AudioM(
      audioName: "Portuguese Language",
      audioLink:
          "https://www.dropbox.com/s/vhyz0fdw9k8wjaj/Japji-Portuguese.mp3?dl=0",
    ),
    AudioM(
      audioName: "Spanish Language",
      audioLink:
          "https://www.dropbox.com/s/if32sscrxmgj9t6/Japji-Spanish.mp3?dl=0",
    ),
  ];
  void initState() {
    isDrawer = false;
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              InkWell(
                                onTap: () {
                                  Get.toNamed(Routes.AUDIOFILE,
                                      arguments: _audioList[index]);
                                  // arguments: _audioList[index]);
                                  // Navigator.push(
                                  //   context,
                                  //   MaterialPageRoute(
                                  //       builder: (context) => AudioFile(
                                  //             audioList: _audioList[index],
                                  //           )),
                                  // );
                                },
                                // onTap: () {
